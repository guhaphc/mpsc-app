...
export default async function Dashboard(){
 ...
 return <div className="shell">
  <header className="topbar"><div className="topbarBrand"><img src="/mpsc-logo.jpg" className="brandLogo dashboardLogo" alt="MPSC ALL-IN-ONE"/></div><form action="/api/auth/signout" method="post"><button className="btn secondary">Logout</button></form></header>
  <main className="main">

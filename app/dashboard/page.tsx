...
export default async function Dashboard(){
 ...
 return <div className="shell">
  <header className="topbar"><img src="/mpsc-logo.svg" className="brandLogo" alt="MPSC ALL-IN-ONE"/><form action="/api/auth/signout" method="post"><button className="btn secondary">Logout</button></form></header>
  <main className="main">
